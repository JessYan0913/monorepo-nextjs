...
import { updateMenu, createMenu, type Menu } from "@/lib/actions/menu"
...
export function MenuInfo({ menu }: { menu?: Menu}) {
      ...
      <Card className="border rounded-lg shadow-sm">
        <Form {...form}>
          <form onSubmit={submit}>
            <input type="hidden" {...form.register("menuId")} value={menu?.menuId} />
            <CardHeader>
