...
export default function CourseEditPage({ params }: { params: { id: string } }) {
  ...
  const validateForm = () => {
    ...
    // 验证视频（如果是录播课程且没有保留原视频）
    if (formData.type === "录播课程" && !formData.video && !videoPreview) {
  ...
  return (
    <div className="flex flex-col gap-6 pb-10">
      ...
      {isLoading ? (
        // 加载状态
        <Card className="max-w-5xl mx-auto w-full shadow-sm p-8">
        ...
        <Card className="max-w-5xl mx-auto w-full shadow-sm">
          <CardHeader className="pb-4">
            ...
            <CardDescription>
              修改以下信息更新课程内容。带 <span className="text-destructive">*</span> 的字段为必填项。
            </CardDescription>
          </CardHeader>
