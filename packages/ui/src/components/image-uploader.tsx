        ...
        <div className="flex flex-1 flex-col justify-center p-4">
          {showPreview ? (
            <div className="space-y-1.5">
              <h4 className="text-sm font-medium">{localFile ? '已选择图片' : '预览'}</h4>
            ...
            <div className="space-y-1.5">
              <p className="text-muted-foreground text-sm">点击或拖拽图片到此处上传</p>
              <p className="text-muted-foreground/80 text-xs">支持 JPG, PNG 格式，最大 5MB</p>
            </div>
          )}
        </div>
